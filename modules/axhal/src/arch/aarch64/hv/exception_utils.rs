...
pub fn read_timer_regs()  {
    ...
    debug!("!!!!!!!!!!!!!!!!!!!!!!!this is cntv_cval_el0:{:#x}", cntv_cval_el0);
    debug!("!!!!!!!!!!!!!!!!!!!!!!!this is cntv_ctl_el0:{:#x}", cntv_ctl_el0);
    debug!("!!!!!!!!!!!!!!!!!!!!!this is cntvct_el0:{:#x}", cntvct_el0);
    debug!("!!!!!!!!!!!!!!!!!this is cntvoff_el2:{:#x}", cntvoff_el2);
    debug!("!!!!!!!!!!!!!!!!!!!!this is cntpct_el0:{:#x}", cntpct_el0);
